...
impl ComputeShader {
    ...
    pub fn from_builder(core: &Core, shader_source: &str, config: ComputeConfiguration) -> Self {
        ...
        // 4 bind groups as default contract.
        for i in 0..4 {
        ...
        log::info!("4 created bind group layouts: {:?}", layout_refs);
        log::info!("create compute pipeline layout with 4 bind group layouts");
    ...
    fn create_output_texture(
        ...
        log::info!(
            "ComputeShader::create_output_texture, width: {}, height: {}, format: {:?}, label: {}",
            width,
            height,
            format,
            label
    ...
    fn create_placeholder_input_texture(device: &wgpu::Device, label: &str) -> TextureManager {
        log::info!(
            "ComputeShader::create_placeholder_input_texture, label: {}",
            label
        );
    ...
    pub fn dispatch(&mut self, encoder: &mut wgpu::CommandEncoder, core: &Core) {
        ...
        if self.dispatch_once && self.current_frame > 0 {
            log::warn!("ComputeShader::dispatch once");
            return;
        }
    ...
    pub fn flip_buffers(&mut self) {
        log::info!("ComputeShader::flip_buffers");
    ...
    pub fn set_custom_params<T: bytemuck::Pod>(&self, params: T, queue: &wgpu::Queue) {
        log::info!(
            "ComupteShader::set_custom_params, self.custome_uniform.is_some: {}",
            self.custom_uniform.is_some()
        );
    ...
    pub fn get_custom_uniform_size(&self) -> Option<u64> {
        log::info!("ComputeShader::get_custom_uniform_size");
    ...
    pub fn update_input_texture(
        ...
        log::info!("ComputeShader::update_input_texture");
    ...
    fn initialize_channel_textures(
        ...
        log::info!("ComputeShader::initialize_channel_textures");
    ...
    fn recreate_group2_bind_group(&mut self, device: &wgpu::Device, queue: &wgpu::Queue) {
        log::info!(
            "ComputeShader::recreate_group2_bind_group, bind_group_layout2.is_some: {}",
            self.bind_group_layouts.get(&2).is_some()
        );
    ...
    fn dispatch_single_pass(
        ...
        log::info!("ComputeShader::dispatch_single_pass");
        for (i, pipeline) in self.pipelines.iter().enumerate() {
            ...
            log::info!("encoder.begin_compute_pass");
            let mut compute_pass = encoder.begin_compute_pass(&wgpu::ComputePassDescriptor {
    ...
    fn dispatch_multipass(
        ...
        log::info!("ComputeShader::dispatch_multipass");
    ...
    pub fn enable_hot_reload(
        ...
        log::info!(
            "ComputeShader::enable_hot_reload, shader_path: {:?}, shader_module: {:?}",
            shader_path,
            shader_module
        );
        ...
        let span = info_span!("[ShaderHotReload]");
        let _guard = span.enter();
        let hot_reload =
    ...
    pub fn check_hot_reload(&mut self, device: &wgpu::Device) -> bool {
        log::info!(
            "ComputeShader::check_hot_reload, hot_reload.is_some: {}",
    ...
    pub fn set_time(&mut self, elapsed: f32, delta: f32, queue: &wgpu::Queue) {
        log::info!(
            "ComputeShader::set_time, elapsed: {}, delta: {}",
            elapsed,
            delta
        );
    ...
    pub fn update_audio_spectrum(
        ...
        log::info!(
            "ComputeShader::update_audio_spectrum, resolution_uniform: {:?}",
            resolution_uniform,
        );
    ...
    pub fn get_output_texture(&self) -> &TextureManager {
        log::info!("ComputeShader::get_output_texture");
        &self.output_texture
    }
    ...
    pub fn resize(&mut self, core: &Core, width: u32, height: u32) {
        log::info!(
            "ComputeShader::resize, width: {}, height: {}",
            width,
            height
        );
